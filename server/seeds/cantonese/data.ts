...
export function generateCantoneseDataset(): LearningItem[] {
  ...
  const nouns = [
    ...
    { w: '智能電話', p: 'zi3 nang4 din6 waa2', m: 'smartphone', c: 'Technology, Computers & Software' },
    { w: '手提電腦', p: 'sau2 tai4 din6 nou5', m: 'laptop computer', c: 'Technology, Computers & Software' },
